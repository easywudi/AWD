						...
						<div class="slider-wrapper theme-theme1215">
							<div class="indent">
								<div class="container">
									...
									<div id="slider" class="nivoSlider">
										<%
											...
											for(HomePage homepage : list){ %>
												<img src="<%=path+homepage.getImgFile()%>" alt="" title="#sliderCaption<%=i %>" />
										<%	
											 	i++;
											} 
										%>
										...
										<%
											int j = 1;
											for(HomePage homepage : list){ %>
												<div class="nivo-html-caption" id="sliderCaption<%=j%>"><dl class="caption">
													<span class="title">project name:</span> <strong><%=homepage.getProjectTitle() %></strong>
													<br /><%=homepage.getProjectDesc() %><a class="arrow-link" href="#"></a>
												</div>
										<%	
											 	j++;
											} 
									...
									<a class="button slider-button" href="project.jsp">View More</a>	
								</div><!-- .container -->
							</div><!-- .indent -->
						</div>	
				    </div>
